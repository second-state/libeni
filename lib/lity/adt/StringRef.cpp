...
bool lity::StrToULongLong(StringRef pStr, unsigned int pRadix,
...
/// @return false only if any error occurs.
bool lity::StrToLongLong(StringRef pStr, unsigned int pRadix,
                             long long& pResult)
{
...
template<> TypeTag lity::type_tag<StringRef>()
{
