...
==----------------------------------------------------------------------===*/
#ifndef LITY_ADT_STRINGREF_H
#define LITY_ADT_STRINGREF_H
#include <iosfwd>
#include <string>
...
inline ostream& operator<<(ostream& pOS, lity::StringRef pStr)
{
  pStr.toStr(pOS);
  return pOS;
}

inline string to_string(lity::StringRef pValue)
{
  return pValue.str();
}
