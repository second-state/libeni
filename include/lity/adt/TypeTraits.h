...
==----------------------------------------------------------------------===*/
#ifndef LITY_TYPE_TRAITS_H
#define LITY_TYPE_TRAITS_H

#include <lity/support/DataTypes.h>
#include <lity/support/ELF.h>
#include <cstdlib>
...
class ELFSizeTraits<32> {
 public:
  typedef lity::ELF::Elf32_Addr Addr;  // Program address
  typedef lity::ELF::Elf32_Off Off;    // File offset
  typedef lity::ELF::Elf32_Half Half;
  typedef lity::ELF::Elf32_Word Word;
  typedef lity::ELF::Elf32_Sword Sword;

  typedef lity::ELF::Elf32_Ehdr Ehdr;
  typedef lity::ELF::Elf32_Shdr Shdr;
  typedef lity::ELF::Elf32_Sym Sym;
  typedef lity::ELF::Elf32_Rel Rel;
  typedef lity::ELF::Elf32_Rela Rela;
  typedef lity::ELF::Elf32_Phdr Phdr;
  typedef lity::ELF::Elf32_Dyn Dyn;
};

template <>
class ELFSizeTraits<64> {
 public:
  typedef lity::ELF::Elf64_Addr Addr;
  typedef lity::ELF::Elf64_Off Off;
  typedef lity::ELF::Elf64_Half Half;
  typedef lity::ELF::Elf64_Word Word;
  typedef lity::ELF::Elf64_Sword Sword;
  typedef lity::ELF::Elf64_Xword Xword;
  typedef lity::ELF::Elf64_Sxword Sxword;

  typedef lity::ELF::Elf64_Ehdr Ehdr;
  typedef lity::ELF::Elf64_Shdr Shdr;
  typedef lity::ELF::Elf64_Sym Sym;
  typedef lity::ELF::Elf64_Rel Rel;
  typedef lity::ELF::Elf64_Rela Rela;
  typedef lity::ELF::Elf64_Phdr Phdr;
  typedef lity::ELF::Elf64_Dyn Dyn;
};
